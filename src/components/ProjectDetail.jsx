...
const TECH_ICONS = {
  ...
  HTML: Code,
  CSS: Code,
  Java: Code, // Added Java
  default: Package,
};

const TechBadge = ({ tech }) => {
  // Extract the tech name from the object (e.g., "Java", "JavaMail API")
  const techName = Object.values(tech)[0]; // Get the value of the first key
  const Icon = TECH_ICONS[techName] || TECH_ICONS["default"];
