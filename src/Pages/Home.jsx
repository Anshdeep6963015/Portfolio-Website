...
const WORDS = ["Full Stack Developer", "3rd Year CSE Student"];
const TECH_STACK = [
  "C",
  "C++",
  "Java",
  ...
  A Computer Science & Engineering student at Chitkara University with a passion for creating impactful, user-friendly applications. Skilled in full-stack development, I enjoy working with modern technologies, solving real-world challenges, and continuously learning to deliver clean, scalable solutions.
            ...
            >
              <div className="relative w-full opacity-90">
                ...
                >
                  <div
                    className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-indigo-500/10 to-green-500/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
