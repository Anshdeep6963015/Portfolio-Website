  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      <div className="absolute -inset-6 opacity-[25%] z-0 hidden sm:block">
        <div className="absolute inset-0 bg-gradient-to-r from-green-600 via-indigo-500 to-green-600 rounded-full blur-2xl animate-spin-slower" />
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-green-500/20 via-transparent to-blue-500/20 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 hidden sm:block" />
...
const AboutPage = () => {
  ...
  const statsData = useMemo(() => [
    ...
    },
    {
      ...
      description: "Click to see Resume",
      animation: "fade-left",
       href: "/resume.pdf"
    },
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold" data-aos="fade-right">
              ...
              <span className="block mt-2 text-gray-200">Anshdeep</span>
            </h2>
...
My name is Anshdeep
I’m a dedicated full-stack developer and Computer Science & Engineering student at Chitkara University, passionate about creating impactful digital solutions. My experience spans building robust backend systems, interactive web applications, and data-driven projects. I thrive on exploring new technologies, applying clean coding practices, and delivering responsive, user-focused products that address real-world needs.</p>

            <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-4">
              <a href="https://github.com/Anshdeep6963015" target="_blank" rel="noreferrer">
